...
支持 `Ubuntu 16.04 / 18.04`、`Debian 8 / 9 / 10` ；低于 `Ubuntu 18.04`、`Debian 10` 的 LTS 系统可以选择用脚本升级系统  
...
注意，Ubuntu 18.04 和 Debian 9 因为 OpenSSL 的原因，只能使用 0.9.6 及以上的版本，更低版本无法直接安装  
